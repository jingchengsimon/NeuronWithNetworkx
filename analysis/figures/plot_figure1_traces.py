#!/usr/bin/env python3
"""
Figure 1 style panels (dendritic + somatic) from trace_analysis / 3_trace_analysis.ipynb.
...
from analysis.trace_analysis import PROJECT_ROOT, _parse_epoch_range, _trapz, process_voltage_data


def _synapse_x_axis(n_points: int, is_expected: bool) -> np.ndarray:
    """Match trace_analysis x ticks: singclus uses 0..72 step 2 (measured) or step 1 (expected)."""
    if is_expected:
