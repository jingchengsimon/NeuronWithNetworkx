        ...
        for i in range(self.num_clusters):
            ...
            if sec_type == 'basal':
                sec_syn_bg_exc_ordered_df = self.section_synapse_df[
                    ...
                    (self.section_synapse_df['branch_idx'] == 4)]  # For concentration level: most branchy basal branch_idx;4
            ...
            if i < 10:
                if spat_condition == 'clus':
                    print(np.unique(syn_surround_ctr))
...
def build_cell(**params):
    ...
    simu_folder = sec_type + '_range' + str(distance_to_root) + '_' + spat_condtion + '_' + simu_condition + '_variedW_concentest_test' # + '_ratio1' + '_exc1.1-1.3' + '_inh4' + '_failprob0.5' + '_funcgroup10'
