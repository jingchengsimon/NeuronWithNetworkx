...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, bg_exc_channel_type, initW, inh_delay, num_trials):
        ...
        # num_activated_preunit_list = range(0, self.num_preunit+5*int(self.num_preunit/100), 5*int(self.num_preunit/100)) #range(0, 100+5, 5) # currently don't exceed 100
    ...
    def run_simulation(self, num_aff_fiber, num_trial):
        ...
        for cluster_id in range(self.num_clusters):
            ...
            try:
                ...
                dend_i_nmda = h.Vector().record(syn_ctr._ref_i)
                dend_i_ampa = h.Vector().record(syn_ctr._ref_i)
