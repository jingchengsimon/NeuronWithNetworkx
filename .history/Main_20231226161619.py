...
num_clusters, cluster_radius, distance_to_soma, num_conn_per_preunit = 5, 3, 1, 3
bg_syn_freq = 1
pref_ori_dg = 0
...
folder_path = f'./results/simulation/pseudo/dist{distance_to_soma}_nClusters{num_clusters}_radius{cluster_radius}_bgFreq{bg_syn_freq}_Prob AMPANMDA_noPosInputs'
