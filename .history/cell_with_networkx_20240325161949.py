...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, num_trials):
        ...
        self.dend_v_array = np.zeros((self.num_clusters, num_time_points, num_epochs, num_trials))
        self.dend_i_array = np.zeros((self.num_clusters, num_time_points, num_epochs, num_trials))
        self.dend_nmda_i_array = np.zeros((self.num_clusters, num_time_points, num_epochs, num_trials))
        self.dend_ampa_i_array = np.zeros((self.num_clusters, num_time_points, num_epochs, num_trials))
        self.soma_v_array = np.zeros((num_time_points, num_epochs, num_trials))
        ...
        for num in num_activated_preunit_list:
