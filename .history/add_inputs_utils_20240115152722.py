...
def add_background_inh_inputs(section_synapse_df, syn_param_inh, spike_interval, lock):  
    exc_types = ['A','C']
    sec_syn_exc_df = section_synapse_df[self.section_synapse_df['type'].isin(exc_types)]
