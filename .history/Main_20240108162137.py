...
num_clusters, cluster_radius, distance_to_soma, num_conn_per_preunit = 1, 5, 4, 1
...
time_tag = time.strftime('%Y-%m-%d %H:%M:%S',time.localtime(time.time()/1000))
...
folder_path = './results/simulation/pseudo/' + time_tag
...
simulation_params = {
    ...
    'number of connections per preunit': num_conn_per_preunit,
}

# Specify the folder path
folder_path = "/path/to/your/folder"

# Specify the file name within the folder
