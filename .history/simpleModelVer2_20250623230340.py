...
class CellWithNetworkx:
    ...
    def assign_clustered_synapses(self, basal_channel_type, sec_type, dis_to_root, 
        ...
        for i in range(self.num_clusters):
            ...
            loop_count = 0
            rng = np.random.RandomState(self.epoch_idx + i)
            ...
            while True:
                ...
                syn_ctr = sec_syn_bg_exc_ordered_df.iloc[rng.choice(len(sec_syn_bg_exc_ordered_df))]
                ...
                if num_syn_per_clus > 1:
                    ...
                    #     clus_mem_max_size_idx = rng.choice(max_clus_mem_idx, 72 - 1, replace=False)
    ...
    def add_inputs(self, folder_path, simu_condition, input_ratio_basal_apic, bg_exc_channel_type, initW, num_func_group, inh_delay, num_trials):
        ...
        spt_rnd = np.random.RandomState(self.epoch_idx) 
        ...
        # self.num_activated_preunit_list = [0, 1, 3, 6, 12, 24, 48, 72] #[self.num_preunit] # for multi-clus
...
zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz
        if simu_condition == 'invivo':zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz
            ...
            add_background_exc_inputs(self.section_synapse_df, 
                                    ...
                                    self.initW,
                                    self.num_func_group,zzzzzzzzzzzzzzzzzz
                                    self.rnd,cccccccccccccccccccccccccccczzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz
                                    self.epoch_idx,
                                    spat_condition,
                                    section_synapse_df_clus,
                                    self.lock)cccccccccccccccccccccccccccccccccccccccccccc
...
def build_cell(**params):
    ...
    if basal_channel_type == 'AMPANMDA':                                                                                
        simu_folder = sec_type + '_range' + str(distance_to_root) + '_' + spat_condtion + '_' + simu_condition + '_singclus' #_variedW_tau43_addNaK_woAP+Ca_aligned_varyinh' # + '_ratio1' + '_exc1.1-1.3' + '_inh4' + '_failprob0.5' + '_funcgroup10'
    elif basal_channel_type == 'AMPA':
            simu_folder = sec_type + '_range' + str(distance_to_root) + '_' + spat_condtion + '_' + simu_condition + '_singclus_AMPA' #variedW_tau43_addNaK_woAP+Ca_aligned_varyinh_AMPA' 
...
if __name__ == "__main__":
    ...
    #     for dis_to_root in [2]: # [0, 1, 2]
    #         for spat_cond in ['distr']: # ['clus', 'distr']
    #             params_list = generate_simu_params(sec_type, spat_cond, dis_to_root)
