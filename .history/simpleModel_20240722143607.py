...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, bg_exc_channel_type, initW, inh_delay, num_trials):
        ...
        self.bg_exc_i_nmda_array = np.zeros((num_exc_syn_on_clustered_sec.size, num_time_points, num_aff_fibers, num_trials))
        self.bg_exc_i_ampa_array = np.zeros((exc_syn_on_clustered_sec.size, num_time_points, num_aff_fibers, num_trials))
        ...
        for num_activated_preunit in num_activated_preunit_list[:1]:
            ...
            for num_trial in range(num_trials):
                ...
                self.run_simulation(num_aff_fiber, num_trial, exc_syn_on_clustered_sec)
    ...
    def run_simulation(self, num_aff_fiber, num_trial, exc_syn_on_clustered_sec):
