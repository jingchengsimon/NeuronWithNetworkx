...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, input_ratio_basal_apic, bg_exc_channel_type, initW, inh_delay, num_trials):
        ...
        self.trunk_i_array = np.zeros((num_time_points, num_aff_fibers, num_trials))
        ...
        clustered_sec = self.section_synapse_df[self.section_synapse_df['type'] == 'C']['section_synapse']
        ...
        np.save(os.path.join(folder_path,'trunk_i_array.npy'), self.trunk_i_array)
    ...
    def run_simulation(self, num_aff_fiber, num_trial):
        ...
        # trunk_i = h.Vector().record(self.complex_cell.apic[3](0.2)._ref_i)
        ...
        self.trunk_i_array[:, num_aff_fiber, num_trial] = np.array(trunk_i)
