...
folder_path = f'./results/simulation/pseudo/dis{distance_to_soma}_nClu{num_clusters}_radius{cluster_radius}_bgFreq{bg_syn_freq}_nSyninClus{num_syn_per_cluster}_exp2syn_noPosInputs'
