...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, initw, num_trials):

        ## change initw in AMPANMDA.json to 0.0001
    json.dump({'initw': 0.0001}, open('./modelFile/AMPANMDA.json', 'w'))
...
def build_cell(**params):
    ...
    cell1.add_inputs(folder_path, initw, num_trials)
