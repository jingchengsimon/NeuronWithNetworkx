...
folder_path = f'./results/simulation/pseudo/dist{distance_to_soma}_nClusters{num_clusters}_radius{cluster_radius}_bgFreq{bg_syn_freq}_nSynClustProbAMPANMDA_noPosInputs'
