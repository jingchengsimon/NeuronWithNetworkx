    ...
    def run_simulation(self, num_stim, num_aff_fiber, num_trial):
        ...
        with self.lock:
            ...
            try:
                ...
                # self.clus_bg_i_ampa_array[:, num_stim, num_aff_fiber, num_trial] = np.sum(np.array(clus_bg_i_ampa_list), axis=0)
                # self.clus_bg_i_nmda_array[:, num_stim, num_aff_fiber, num_trial] = np.sum(np.array(clus_bg_i_nmda_list), axis=0)
