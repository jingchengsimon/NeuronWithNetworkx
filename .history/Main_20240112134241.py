...
def your_function(parameter):
    ...
    folder_path = './results/simulation/pseudo/' + 'AMPA_' + time_tag
...
if __name__ == "__main__":
    ...
    param1_diff = {
        'param_specific_key': 'value1',
        'another_specific_key': 'value2',
        # 添加 param1 特有的其他键值对
    }

    param2_diff = {
        'param_specific_key': 'value3',
        'yet_another_specific_key': 'value4',
        # 添加 param2 特有的其他键值对
    }
