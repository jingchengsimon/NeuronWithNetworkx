...
def build_cell(param):

    basal_channel_type, distance_to_soma,num_clusters, num_syn_per_cluster, cluster_radius, bg_syn_freq, num_conn_per_preunit, pref_ori_dg = param.values()
    # 创建保存文件夹
    ...
    folder_path = './results/simulation/pseudo/' + basal_channel_type + time_tag
    ...
    cell1.add_synapses(NUM_SYN_BASAL_EXC, 
                                ...
                                NUM_SYN_BASAL_INH, 
                                NUM_SYN_APIC_INH)
    cell1.assign_clustered_synapses(num_clusters, cluster_radius, distance_to_soma, num_conn_per_preunit, num_syn_per_cluster, basal_channel_type, pref_ori_dg) 
...
if __name__ == "__main__":
    ...
    # 构建参数列表
    parameters_list = [
        {**param1_common, **param1_diff},
        {**param1_common, **param2_diff}
    ]
