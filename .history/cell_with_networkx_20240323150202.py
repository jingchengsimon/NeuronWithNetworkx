...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path):
        ...
        for num_syn_to_get_input in range(self.num_syn_per_cluster):
            ...
            add_clustered_inputs(self.section_synapse_df, self.syn_param_exc, self.num_clusters, 
                         self.num_conn_per_preunit, basal_channel_type, 
                         num_syn_to_get_input, num_activated_preunit, spt_unit_list_truncated, self.lock)
