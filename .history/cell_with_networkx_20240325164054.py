...
class CellWithNetworkx:
    ...
    def run_simulation(self, num_aff_fiber, num_trial):
        ...
        for num_cluster in range(self.num_clusters):
            self.dend_v_array[num_cluster, :, num_aff_fiber, num_trial] = np.array(dend_v_list[num_cluster])
            self.dend_i_array[num_cluster, :, num_aff_fiber, num_trial] = np.array(dend_i_list[num_cluster])
            self.dend_nmda_i_array[num_cluster, :, num_aff_fiber, num_trial] = np.array(dend_i_nmda_list[num_cluster])
            self.dend_ampa_i_array[num_cluster, :, num_aff_fiber, num_trial] = np.array(dend_i_ampa_list[num_cluster])
