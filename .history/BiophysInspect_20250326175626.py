...
def nonlinearity_visualization(exp, k, fig, ax, data_type, stack_flag, exp_idx, alpha=1):
    ...
    num_preunit = 72
    syn_num_list = list(range(0, num_preunit + 8, 8))
    ...
    ax.flat[k//syn_num_step].set_xticks(list(range(0, num_preunit + 8, 8)))
...
anal_loc, range_idx, col_idx, num_epochs = 'basal', 0, 0, 2 # range_idx: 0-2, col_idx: 0-5
