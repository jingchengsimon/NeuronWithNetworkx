...
class CellWithNetworkx:
    def __init__(self, swc_file, bg_exc_freq, bg_inh_freq, SIMU_SEC):
        ...
        self.DURATION = 1000 * SIMU_SEC # 60s 
    ...
    def add_inputs(self, folder_path, bg_exc_channel_type, initW, num_trials):
    ...
    def run_simulation(self, num_aff_fiber, num_trial):
        ...
        # Record summed local NMDA current
...
def build_cell(**params):
    ...
    cell1 = CellWithNetworkx(swc_file_path, bg_exc_freq, bg_inh_freq, SIMU_SEC)
    ...
    cell1.add_inputs(folder_path, bg_exc_channel_type, initW, num_trials)
