...
class CellWithNetworkx:
    ...
    def assign_clustered_synapses(self, basal_channel_type, sec_type, dis_to_root, 
        ...
        # Extract distances
        basal_distance = self.section_synapse_df[(section_synapse_df['region'] == 'basal') & (section_synapse_df['type'] == 'A')]['distance_to_soma'].values
        tuft_distance = sself.ection_synapse_df[(section_synapse_df['distance_to_tuft'] != -1) & (section_synapse_df['type'] == 'A')]['distance_to_tuft'].values
