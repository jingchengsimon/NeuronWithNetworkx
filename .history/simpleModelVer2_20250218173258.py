...
class CellWithNetworkx:
    ...
    def add_single_synapse(self, num_syn, region, sim_type):
        ...
        def generate_synapse(_):
            ...
            section_id_synapse = self.section_df[self.section_df['section_name'] == section_name]['section_id'].values[0] #self.section_df.loc[self.section_df['section_name'] == section_name, 'section_id'].values[0]
            branch_idx = self.section_df.loc[self.section_df['section_name'] == section_name, 'branch_idx'].values[0]
