...
class CellWithNetworkx:
        ...
        for i in range(self.num_clusters):
            ...
            if sec_type == 'basal':
                sec_syn_bg_exc_ordered_df = self.section_synapse_df[
                    ...
                    (self.section_synapse_df['section_id_synapse'] == 40)] # specifically choose the branch 
                ...
                sec_syn_bg_exc_ordered_df = self.section_synapse_df[
                    ...
                    (self.section_synapse_df['section_id_synapse'] == 145)] # specifically choose the branch 
            ...
            while True:
                ...
                # choose the max loc one
                syn_ctr = sec_syn_bg_exc_ordered_df.loc[sec_syn_bg_exc_ordered_df['loc'].idxmax()]
    ...
    def add_inputs(self, folder_path, simu_condition, input_ratio_basal_apic, bg_exc_channel_type, initW, num_func_group, inh_delay, num_trials):
        ...
        self.num_activated_preunit_list = range(0, self.num_preunit + 8, 8)
        ...
        for num_activated_preunit in self.num_activated_preunit_list: # self.num_activated_preunit_list[-1:] # 40
...
def build_cell(**params):
    ...
    simu_folder = sec_type + '_range' + str(distance_to_root) + '_' + spat_condtion + '_' + simu_condition + '_fixedW_tau90_shifted_addNaK_branchtest_varynumsyn' # + '_ratio1' + '_exc1.1-1.3' + '_inh4' + '_failprob0.5' + '_funcgroup10'
