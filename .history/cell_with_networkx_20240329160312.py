...
class CellWithNetworkx:
    def __init__(self, swc_file, bg_syn_freq):
        ...
        self.apical_tuft_start_point_idx = self.all_sections.index(self.sections_apical[36])
        ...
        self.class_dict_soma, self.class_dict_tuft = set_graph_order(self.G, self.DiG, self.apical_tuft_start_point_idx)
