...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path):
        ...
        spt_unit_list = create_vecstim(unit_ids, self.num_stim, folder_path)
        ...
        for num_activated_preunit in range(4, self.num_preunit, 5):
            ...
            spt_unit_list_truncated = spt_unit_list[:num_activated_preunit+1]
            ...
            for trial_idx in range(num_trials):
                ...
                # Run the simulation
                num_per_epoch = int(num_activated_preunit/5)
                # self.run_simulation(num_syn_to_get_input, trial_idx)
                self.run_simulation(num_per_epoch, trial_idx)
