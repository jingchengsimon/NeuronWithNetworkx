...
def visualize_morpho(section_synapse_df, soma_v, seg_v):
    ...
    cmap = cm.cool
    seg_syn_df = self.section_synapse_df[section_synapse_df['type'] == 'C']['segment_synapse'].values
    soma = self.section_synapse_df[section_synapse_df['region'] == 'soma']['section_synapse'].values[0]
