...
class CellWithNetworkx:
    def __init__(self, swc_file, bg_exc_freq, bg_inh_freq, DURATION):
        ...
        self.section_synapse_df = pd.DataFrame(columns=['section_id_synapse',
                                                ...
                                                'pre_unit_id',
                                                'region',
                                                'spike_train']) # for adding vecstim of different orientation
    ...
    def add_inputs(self, folder_path, input_ratio_basal_apic, bg_exc_channel_type, initW, inh_delay, num_trials):
        ...
        #         list(trial_executor.map(lambda num_trial: process_trial(num_activated_preunit, num_trial), 
        #                                     range(num_trials)), total=num_trials)
        ...
        for num_activated_preunit in num_activated_preunit_list[19:1]: # 40
        ...
        #     list(unit_executor.map(process_unit, num_activated_preunit_list), total=num_aff_fibers)
