...
if __name__ == '__main__':
    ...
    cluster_radius = 50
    num_stim = 1
    num_conn_per_preunit = 10
    basal_channel_type = 'na'
    sec_type = 'basal'
    dis_to_root = 100
    num_trials = 1
    folder_path = './data'

    cell = CellWithNetworkx(swc_file, bg_exc_freq, bg_inh_freq)
    cell.add_synapses(num_syn_basal_exc, num_syn_apic_exc, num_syn_basal_inh, num_syn_apic_inh)
    cell.assign_clustered_synapses(basal_channel_type, sec_type, dis_to_root, num_clusters, cluster_radius, num_stim, num_conn_per_preunit, folder_path)
    cell.add_inputs(folder_path, num_trials)