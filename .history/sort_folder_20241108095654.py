...
# I want basal distance from clusters to root 1 2 3 and apical distance from clusters to root 1 2 3 in the same folder. And sort the folders based on the information in the simulation_params.json file.