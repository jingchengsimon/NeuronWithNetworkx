...
PARAMETER {
        ...
        tau_r_AMPA = 0.2 (ms) :1   (ms)  : dual-exponential conductance profile
        tau_d_AMPA = 1.7 (ms) :2    (ms)  : IMPORTANT: tau_r < tau_d
	tau_r_NMDA = 0.29 (ms) :5   (ms) : dual-exponential conductance profile
        tau_d_NMDA = 43 (ms) :90     (ms) : IMPORTANT: tau_r < tau_d
