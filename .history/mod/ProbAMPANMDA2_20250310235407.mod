...
PARAMETER {
        ...
        tau_r_AMPA =  0.2 :0.2   (ms)  : dual-exponential conductance profile
        tau_d_AMPA = 1.7 :1.7    (ms)  : IMPORTANT: tau_r < tau_d
	tau_r_NMDA = 0.29 :0.29   (ms) : dual-exponential conductance profile
        tau_d_NMDA = 43 :43     (ms) : IMPORTANT: tau_r < tau_d
