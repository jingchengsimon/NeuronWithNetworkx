...
def add_clustered_inputs(section_synapse_df, num_clusters, basal_channel_type, initW, spt_unit_array, section_synapse_df_clus, rnd):  
    ...
    for j in range(num_clusters):
        ...
        for i in range(num_syn_clustered):
            ...
            if spat_condition == 'clus':
                ...
                spt_unit_nonbg = ast.literal_eval(section['spike_train'])[0]  # the corresponding spike train with the identical number of synchronous inputs
