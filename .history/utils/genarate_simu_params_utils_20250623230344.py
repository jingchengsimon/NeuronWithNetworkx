...
def generate_simu_params(sec='basal', spat_cond='clus', dist=0):
    ...
    sec_type = [sec] # basal or apicalzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz
    dis_to_root = [dist]
    ...
    num_syn_per_clus = [72zzzzzzzzzzzzzzzzzzzzz]  # [1, 3, 6, 12, 24, 48, 72] [24, 32, 40, 48, 56, 64, 72]   
