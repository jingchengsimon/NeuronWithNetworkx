...
def generate_simu_params():
    ...
    spat_condition = ['c'] # clus or distr
    num_clusters = [2] # 5 This number just approximates the distribution of clusters from the same source
    num_conn_per_preunit = [5] # 5
    num_preunit = [2*16] # 80 * 5 / 10 = 40 syn per cluster
