...
def add_background_inh_inputs(section_synapse_df, syn_param_inh, DURATION, FREQ_INH, 
    ...
    if sec_syn_bg_inh_df['spike_train_bg'] is None:
        ...
        spike_trains_inh_bg = np.array([spikes[0] for spikes in sec_syn_bg_inh_df['spike_train_bg']], dtype=object)# The first one is the inh spike train w/o synchronous input
