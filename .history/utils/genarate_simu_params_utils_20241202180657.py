...
def generate_simu_params():
    ...
    spat_condition = ['distr', 'clus'] # clus or distr
    ...
    num_clusters = [1, 2, 3, 6, 9, 18, ] # 5 This number just approximates the distribution of clusters from the same source
    num_conn_per_preunit = [3] # 3
    num_syn_per_clus = [16, 24, 32] # 80 * 5 / 10 = 40 syn per cluster
