...
def add_background_exc_inputs(section_synapse_df, syn_param_exc, DURATION, FREQ_EXC, bg_exc_channel_type, initW, lock):
    ...
    pink_noise_array = make_noise(num_traces=num_syn_background_exc, num_samples=DURATION)
    def process_section(i):
        ...
        # random.choose(list, 10_list) 1/f specctrum
        counts = np.random.poisson(FREQ_EXC/1000, DURATION) # give a array
