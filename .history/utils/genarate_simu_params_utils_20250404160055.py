...
def generate_simu_params(sec='basal', spat_cond='clus', dist=0):
    ...
    ## Invivo params
    bg_exc_freq = [1.3] # basal ->0.5 1/4
    bg_inh_freq = [4] # basal the ratio of exc/inh is 1:4 for both basal and apical
    input_ratio_basal_apic = [1]
    initW = [0.0004] # 0.00016 uS = 0.16 nS
    num_func_group = [10]
    inh_delay = [4] # 4 ms

    num_conn_per_preunit = [3] # 3
    num_clusters = [1, 2, 3, 6, 9, 18]  # [1, 2, 3, 6, 9, 18] 
    num_syn_per_clus = [1, 3, 6, 12, 24, 48, 72]  # [1, 3, 6, 12, 24, 48, 72] [24, 32, 40, 48, 56, 64, 72]   
