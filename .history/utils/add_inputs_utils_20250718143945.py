...
def add_background_exc_inputs_2(section_synapse_df, all_segments_dend, syn_param_exc, DURATION, FREQ_EXC, 
                              input_ratio_basal_apic, bg_exc_channel_type, initW, num_func_group, 
                              epoch_idx, spk_epoch_idx, spat_condition, section_synapse_df_clus):
    ...
    num_func_group = 639 #num_func_group # (26,000/5)/100 = 52
    pink_noise_array = make_noise(num_traces=num_func_group, num_samples=DURATION)
    ...
    section = sec_syn_bg_exc_df.iloc[0]
    section_synapse = section['section_synapse']
    loc = section['loc']
    
    matching_segments = all_segments_dend[all_segments_dend['section_name'] == section_synapse]
