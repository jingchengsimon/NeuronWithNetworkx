...
def add_background_inh_inputs(section_synapse_df, syn_param_inh, DURATION, FREQ_INH, 
                              input_ratio_basal_apic, num_syn_inh_list, inh_delay, rnd, epoch_idx, lock):  
    ...
    return spike_counts_generation(exc_types), num_syn_basal_inh, num_syn_apic_inh, num_syn_soma_inh

    spike_counts_basal_inh, num_syn_basal_inh, spike_counts_apic_inh, num_syn_apic_inh, spike_counts_soma_inh, num_syn_soma_inh = spike_counts_generation(exc_types)
