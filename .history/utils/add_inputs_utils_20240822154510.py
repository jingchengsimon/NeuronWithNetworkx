...
def add_background_exc_inputs(section_synapse_df, syn_param_exc, DURATION, FREQ_EXC, 
    ...
    num_preunit_exc_basal = int(len(sec_syn_bg_exc_df[sec_syn_bg_exc_df['region'] == 'basal'])
    num_preunit_exc_apical = len(sec_syn_bg_exc_df[sec_syn_bg_exc_df['region'] == 'apical'])
