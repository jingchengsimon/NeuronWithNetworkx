...
def add_background_exc_inputs(section_synapse_df, syn_param_exc, DURATION, FREQ_EXC, 
                              input_ratio_basal_apic, bg_exc_channel_type, initW, num_func_group, epoch_idx, spk_epoch_idx, 
    ...
    loc_rnd = np.random.default_rng(spk_epoch_idx + i)
    sigma = 1
...
def add_background_inh_inputs(section_synapse_df, syn_param_inh, DURATION, FREQ_INH, 
                              inh_delay, epoch_idx, spat_condition, 
