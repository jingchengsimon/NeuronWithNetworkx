...
def add_background_exc_inputs_2(section_synapse_df, syn_param_exc, DURATION, FREQ_EXC, 
    ...
    num_func_group = segments_dend_df.shape[0] #num_func_group # (26,000/5)/100 = 52
    pink_noise_array = make_noise(num_traces=num_func_group, num_samples=DURATION,scale=5)
