...
def generate_simu_params():
    ...
    NUM_SYN_BASAL_EXC = [10042, 1] #[10042, 10042-4000, 10042-8000]
    NUM_SYN_APIC_EXC = [16070, 1] #[16070, 16070-6400, 16070-12800]
    NUM_SYN_BASAL_INH = [1023, 1] # 1023
    NUM_SYN_APIC_INH = [1637, 1] # 1637
