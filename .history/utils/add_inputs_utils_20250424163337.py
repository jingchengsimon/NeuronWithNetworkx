...
def add_background_inh_inputs(section_synapse_df, syn_param_inh, DURATION, FREQ_INH, 
    ...
    if sec_syn_bg_inh_df['spike_train_inh_bg'] is None:
        ...
        spike_train_inh_bg = rnd.poisson(lambda_array_bg/1000, size=(int(num_syn_bg_inh/1), DURATION))
    else:
        spike_train_inh_bg = sec_syn_bg_inh_df['spike_train_inh_bg'][0]
    ...
    spike_train_inh = np.unique(np.concatenate((spike_train_inh_bg, spike_train_inh_sync))) # each time point only once
