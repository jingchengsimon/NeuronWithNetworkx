...
def add_background_exc_inputs(section_synapse_df, syn_param_exc, DURATION, FREQ_EXC, spike_interval, bg_exc_channel_type, initW, lock):
    ...
    def process_section(i):
        ...
        spike_train = spike_times_int_inh + np.random.rand(np.sum(counts)) 
