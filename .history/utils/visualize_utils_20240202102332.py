...
def visualize_synapses(section_synapse_df, folder_path, title='Synapses'):
        ...
        file_path = os.path.join(folder_path, f'synapses.png')
...
def visualize_summary_simulation(time_v, dend_v_list, dend_v_peak_list, soma_v_list, soma_v_peak_list, folder_path):
    ...
    file_path = os.path.join(folder_path, f'volatge_time.png')
    plt.savefig(file_path)
    plt.close(i)
    ...
    file_path = os.path.join(folder_path, f'volatge_numOfSyn.png')
    plt.savefig(file_path)
    plt.close(i)
