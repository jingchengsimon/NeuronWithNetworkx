...
def add_clustered_inputs(section_synapse_df, syn_param_exc, num_clusters, num_conn_per_preunit, basal_channel_type, num_syn_to_get_input, spt_unit_list):  
    ...
    for j in range(num_clusters):
        ...
        for i in tqdm(range(num_syn_clustered)):
            ...
            netstim.interval = 10 # ms (the default value is 10 ms, so it's not necessary to set it here)
