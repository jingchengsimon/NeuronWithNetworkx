...
def add_background_exc_inputs(section_synapse_df, syn_param_exc, DURATION, FREQ_EXC, 
    ...
    def process_section(i):
        ...
        section_synapse_df.at[section.name, 'spike_train'] = spike_train # generate an array to save spike_train for each synapse
...
def add_background_inh_inputs(section_synapse_df, syn_param_inh, DURATION, FREQ_INH, 
    ...
    spike_times = section_synapse_df[section_synapse_df['type'].isin(exc_types)][]
