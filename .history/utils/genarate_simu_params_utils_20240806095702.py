...
def generate_simu_params():
    ...
    NUM_SYN_APIC_EXC = [0, 3000, 6070, 9000, 12000, 16070] # [16070, 16070-6400, 16070-12800]
    NUM_SYN_BASAL_INH = [1023] # 1023
    NUM_SYN_APIC_INH = [0] # 1637
    ...
    bg_exc_freq = [1] # basal
    bg_inh_freq = [4] # basal the ratio is 1:4 for both basal and apic
    bg_exc_channel_type = ['AMPANMDA']
    initW = [0.1]
    inh_delay = [4] # 4 ms

    num_of_stim = [1]
    stim_time = [1000] # 2500 ms
