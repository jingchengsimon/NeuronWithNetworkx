...
def add_background_exc_inputs(section_synapse_df, syn_param_exc, DURATION, FREQ_EXC, 
    ...
    initW_distr_list = loc_rnd.choice(syn_w_distr, size=num_syn_bg_exc, replace=True)
        ...
        if section['synapse'] is None:
            ...
            if bg_exc_channel_type == 'Exp2Syn':
                ...
                if spat_condition == 'clus':
                    ...
                    initW_distr =  initW_distr_list[i]
...
def add_clustered_inputs(section_synapse_df, num_clusters, basal_channel_type, initW, spt_unit_array, epoch_idx):  
    ...
    total_synapses = num_clusters * num_syn_clustered_per_cluster
    initW_zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz = loc_rnd.choice(syn_w_distr, size=total_synapses)
