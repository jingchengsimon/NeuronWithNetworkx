...
def generate_simu_params():
    ...
    num_clusters = [1,2,3,4,5] # 5 This number just approximates the distribution of clusters from the same source
    num_conn_per_preunit = [5] # 5
    num_preunit = [16] # 80 * 5 / 10 = 40 syn per cluster
