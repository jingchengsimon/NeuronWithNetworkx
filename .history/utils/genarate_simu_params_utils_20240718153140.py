...
def generate_simu_params():
    ...
    num_clusters = [20] # don't vary the num of clusters 
                        # because with the same num of presyn nodes, diff num of clusers means diff clustered syn density
                        # e.g. 4*100 syns for 20 clusters, then avg 20 syns per cluster; for 10 clusters, avg 40 syns per cluster
