...
def generate_simu_params():
    ...
    num_clusters = [3] # 5 This number just approximates the distribution of clusters from the same source
    num_conn_per_preunit = [5] # 5
    num_preunit = [3*16] # 80 * 5 / 10 = 40 syn per cluster
    ...
    combinations = list(product(NUM_SYN_BASAL_EXC,
                                ...
                                NUM_SYN_SOMA_INH,
                                DURATION,
                                simu_condition, spat_condition, basal_channel_type, sec_type,
