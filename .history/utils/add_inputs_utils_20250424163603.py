...
def add_background_inh_inputs(section_synapse_df, syn_param_inh, DURATION, FREQ_INH, 
    ...
    if sec_syn_bg_inh_df['spike_train_inh'] is None:
        ...
        spike_train_inh = sec_syn_bg_inh_df['spike_train_inh'][0] # The first one is the inh spike train w/o synchronous spikes
    ...
    def process_section(i):
        ...
        if spat_condition == 'clus':
            ...
            spike_train_inh = ast.literal_eval(section_clus['spike_train_inh'])[0]
