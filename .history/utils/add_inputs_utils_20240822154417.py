...
def add_background_exc_inputs(section_synapse_df, syn_param_exc, DURATION, FREQ_EXC, 
    ...
    num_syn_background_exc_basal = len(sec_syn_bg_exc_df[sec_syn_bg_exc_df['region'] == 'basal'])
    num_syn_background_exc_apical = len(sec_syn_bg_exc_df[sec_syn_bg_exc_df['region'] == 'apical'])
    ...
    with ThreadPoolExecutor(max_workers=multiprocessing.cpu_count()) as executor:
        executor.map(process_generate_basal_spike_train, range(num_syn_background_exc))
