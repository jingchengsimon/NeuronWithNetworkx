...
def create_directed_graph(all_sections, all_segments, section_df):
    ...
    pos = graphviz_layout(DiG, prog="dot")
    nx.draw(DiG, pos, with_labels=True, node_size=100, font_size=5)
    plt.title("Section-Level DiGraph")

    plt.figure(figsize=(12, 6))
    pos = graphviz_layout(segment_DiG, prog="dot")
    nx.draw(segment_DiG, pos, with_labels=True, node_size=100, font_size=5)
