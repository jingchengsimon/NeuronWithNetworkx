...
# path = '/G/results/simulation/overall_simulation_pdfonly/'
# delete_npy_files(path)

# # Define the path to the folders
base_path = '/G/results/simulation/20241112_1029/'
output_base_path = '/G/results/simulation/diff_clussize_simulation/'
