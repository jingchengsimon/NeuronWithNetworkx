...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, input_ratio_basal_apic, bg_exc_channel_type, initW, inh_delay, num_trials):
        ...
        basal_exc = self.section_df.iloc[5]['section_name']
        num_exc_syn_on_basal_sec = self.section_synapse_df[(self.section_synapse_df['section_synapse'].isin(clustered_sec)) &
