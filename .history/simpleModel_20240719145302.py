...
class CellWithNetworkx:
    ...
    def run_simulation(self, num_aff_fiber, num_trial):
        ...
        clustered_syn_sec = self.section_synapse_df[self.section_synapse_df['type'] == 'C']['section_synapse']
        syn_on_clustered_sec = [syn for syn in clustered_syn_sec if syn in self.sections_basal or syn in self.sections_apical]
