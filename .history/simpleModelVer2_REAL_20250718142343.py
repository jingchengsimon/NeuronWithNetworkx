...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, simu_condition, input_ratio_basal_apic, bg_exc_channel_type, initW, num_func_group, inh_delay, num_trials):
        ...
        if simu_condition == 'invivo':
            ...
            add_background_exc_inputs_2(self.section_synapse_df, self.num_syn_basal_exc, self.num_syn_apic_exc, self.syn_param_exc, self.SIMU_DURATION, self.FREQ_EXC, 
...
def build_cell(**params):
    ...
    if basal_channel_type == 'AMPANMDA':                                                                                
        simu_folder = sec_type + '_range' + str(distance_to_root) + '_' + spat_condtion + '_' + simu_condition + '_NATURAL_exc1.3' #_variedW_tau43_addNaK_woAP+Ca_aligned_varyinh' # + '_ratio1' + '_exc1.1-1.3' + '_inh4' + '_failprob0.5' + '_funcgroup10'
