...
folder_path = f'./results/simulation/pseudo/Apical_NMDA_dist{distance_to_soma}_nClus{num_clusters}_nSyn{num_syn_per_cluster}_r{cluster_radius}_bgFreq{bg_syn_freq}_nIn{num_conn_per_preunit}'
