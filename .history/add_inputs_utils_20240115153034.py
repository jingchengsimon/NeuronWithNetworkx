...
def add_background_inh_inputs(section_synapse_df, syn_param_inh, time_interval, DURATION, FREQ_INH, num_syn_basal, lock):  
    exc_types = ['A','C']
    ...
    num_syn_basal_inh, num_syn_apic_inh = num_syn_basal
