...
num_clusters, cluster_radius, distance_to_soma, num_conn_per_preunit = 10, 5, 6, 10
...
folder_path = f'./results/simulation/pseudo/Apical_AMPANMDA_dist{distance_to_soma}_nClus{num_clusters}_nSyn{num_syn_per_cluster}_r{cluster_radius}_bgFreq{bg_syn_freq}_nIn{num_conn_per_preunit}'
