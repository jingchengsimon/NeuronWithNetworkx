...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, input_ratio_basal_apic, bg_exc_channel_type, initW, inh_delay, num_trials):
        ...
        self.bg_exc_i_nmda_array = np.zeros((num_exc_syn_on_basal_sec, num_time_points, num_aff_fibers, num_trials))
        self.bg_exc_i_ampa_array = np.zeros((num_exc_syn_on_tuft_sec, num_time_points, num_aff_fibers, num_trials))
