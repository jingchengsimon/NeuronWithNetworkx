...
class CellWithNetworkx:
    ...
    def run_simulation(self, num_aff_fiber, num_trial):
        ...
        basal_v = h.Vector().record(self.complex_cell.dend[4](0.5)._ref_v) # the 5th dendrite, L: 84
        tuft_v = h.Vector().record(self.complex_cell.apic[44](0.5)._ref_v) # the 129th dendrite
