...
num_clusters, cluster_radius, distance_to_soma, num_conn_per_preunit = 5, 5, 5, 3
num_syn_per_cluster = 30
bg_syn_freq = 1
pref_ori_dg = 0
...
folder_path = f'./results/simulation/pseudo/dist{distance_to_soma}_nClusters{num_clusters}_radius{cluster_radius}_bgFreq{bg_syn_freq}_nSyninClus{num_syn_per_cluster}_ProbAMPANMDA_noPosInputs'
