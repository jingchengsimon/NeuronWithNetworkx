...
class CellWithNetworkx:
    ...
    def run_simulation(self, num_aff_fiber, num_trial):
        ...
        for cluster_id in range(self.num_clusters):
            ...
            exc_syn_on_clus_sec = list(filter(None, self.section_synapse_df[(self.section_synapse_df['section_synapse'].isin(clustered_sec)) & 
            ...
            for exc_syn in exc_syn_on_clus_sec:
                ...
                # except AttributeError:
                    # dend_i_nmda = h.Vector([])
                    # dend_i_ampa = h.Vector([])
