...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path):
        ...
        np.save(folder_path + '/soma_v_array.npy', self.soma_v_array)  
        np.save(folder_path + '/dend_v_array.npy', self.dend_v_array)
        np.save(folder_path + '/dend_i_array.npy', self.dend_i_array)
        np.save(folder_path + '/dend_nmda_i_array.npy', self.dend_nmda_i_array)
        np.save(folder_path + '/dend_ampa_i_array.npy', self.dend_ampa_i_array)
