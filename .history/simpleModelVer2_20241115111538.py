...
def build_cell(**params):
    ...
    folder_path = '/G/results/simulation/' + sec_type + '_range' + str(distance_to_root) + '/' + folder_tag + '/' + str(epoch)
    + '/' + folder_tag + '/' + str(epoch)
...
def run_processes(parameters_list):
    ...
    for epoch in range(1, 11):  # Run different assignments with the same parameters
