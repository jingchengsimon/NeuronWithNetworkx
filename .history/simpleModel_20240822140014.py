...
class CellWithNetworkx:
    ...
    def process_trial(self, num_activated_preunit, num_trial):
            # 添加背景兴奋性输入
    ...
    def add_inputs(self, folder_path, input_ratio_basal_apic, bg_exc_channel_type, initW, inh_delay, num_trials):
        ...
        self.num_syn_inh_list = [self.num_syn_basal_inh, self.num_syn_apic_inh]
        ...
        processes = []
        for num_activated_preunit in num_activated_preunit_list[:4]: # 40
            ...
            for num_trial in range(num_trials): # 20
                ...
                process = multiprocessing.Process(target=process_trial, 
                                              args=(num_activated_preunit, num_trial))
    ...
    def run_simulation(self, num_aff_fiber, num_trial):
        ...
        print(f'simu num_aff_fiber: {num_aff_fiber}, num_trial: {num_trial} done')
