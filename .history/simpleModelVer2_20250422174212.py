...
def build_cell(**params):
    ...
    # get the remainder of the folder_tag to 42, use 42 instead of 0 for exact division   variedW_tau43_addNaK_nonlintest_woAP+Ca_withclus_aligned_gNMDA1_ratio2_UNREAL
