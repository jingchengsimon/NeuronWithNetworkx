...
class CellWithNetworkx:
    def __init__(self, swc_file, bg_exc_freq, bg_inh_freq, SIMU_DURATION, STIM_DURATION, epoch_idx):
        ...
        self.rnd = np.random.RandomState(epoch_idx) 
    ...
    def assign_clustered_synapses(self, basal_channel_type, sec_type, dis_to_root, 
        ...
        for i in range(self.num_clusters):
            ...
            sec_syn_bg_exc_df = self.section_synapse_df[(self.section_synapse_df['type'] == 'A') & (self.section_synapse_df['cluster_flag'] == -1)]
            ...
            while True:
                ...
                if num_syn_per_clus > 1:
                    ...
                    self.section_synapse_df.loc[syn_surround_ctr.iloc[clus_mem_idx].index, 'type'] = 'A'
            ...
            self.section_synapse_df.loc[syn_ctr.name, 'type'] = 'A'
