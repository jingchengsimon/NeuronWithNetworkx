...
class CellWithNetworkx:
    ...
    def _run_simulation(self, ori_dg, stim_id, stim_index):
        ...
        # dend_i = h.Vector().record(syn_ctr._ref_iampa)
        # dend_i_nmda = h.Vector().record(syn_ctr._ref_inmda)
        # dend_i_ampa = h.Vector().record(syn_ctr._ref_iampa)
        ...
        print('peak of dend_v:', max(dend_v))
