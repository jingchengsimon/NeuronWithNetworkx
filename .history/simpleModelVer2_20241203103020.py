...
class CellWithNetworkx:
    ...
    def assign_clustered_synapses(self, basal_channel_type, sec_type, dis_to_root, 
                                  ...
                                  spat_condition, num_conn_per_preunit, num_preunit_per_clus,
                                  folder_path):
        ...
        # num_preunit = num_preunit_per_clus * num_clusters
        max_num_preunit_per_clus = 32
        num_preunit = max_num_preunit_per_clus * num_clusters # set the maximum

        # we set the replace=False, when we don't have enough clusters to be assigned separately, we set num_conn to be num_clus
        num_conn_per_preunit = num_conn_per_preunit if num_clusters >= 3 else num_clusters 
        ...
        self.num_clusters_sampled  = num_clusters if num_clusters <= 24 else 24
        ...
        self.num_preunit = num_preunit_per_clus * num_clusters # num_preunit
...
def build_cell(**params):
    ...
    simulation_params = {
        ...
        'number of preunits per cluster': num_preunit_per_clus,
    ...
    cell1.assign_clustered_synapses(basal_channel_type, sec_type, distance_to_root, 
                                    num_clusters, cluster_radius, num_stim, stim_time, 
                                    spat_condtion, num_conn_per_preunit, num_preunit_per_clus,
                                    folder_path) 
