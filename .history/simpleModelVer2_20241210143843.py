...
class CellWithNetworkx:
    ...
    def assign_clustered_synapses(self, basal_channel_type, sec_type, dis_to_root, 
        ...
        for i in range(self.num_clusters):
            ...
            max_num_syn_per_cluster = num_syn_per_cluster # max(num_syn_per_cluster, 100)
            ...
            max_cluster_member_index = distance_synapse_mark_compare(dis_syn_from_ctr, mdis_mark_from_ctr)
