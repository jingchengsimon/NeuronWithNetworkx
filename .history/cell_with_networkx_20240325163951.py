...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, num_trials):
        ...
        for num_activated_preunit in num_activated_preunit_list:
            ...
            for trial_idx in range(num_trials):
                ...
                self.run_simulation(num_aff_fiber, trial_idx)
    ...
    def run_simulation(self, num_aff_fiber, trial_idx):
        ...
        self.soma_v_array[:, num_aff_fiber, trial_idx] = np.array(soma_v)
        for cluster_id in range(self.num_clusters):
            self.dend_v_array[cluster_id, :, num_aff_fiber, trial_idx] = np.array(dend_v_list[cluster_id])
            self.dend_i_array[cluster_id, :, num_aff_fiber, trial_idx] = np.array(dend_i_list[cluster_id])
            self.dend_nmda_i_array[cluster_id, :, num_aff_fiber, trial_idx] = np.array(dend_i_nmda_list[cluster_id])
            self.dend_ampa_i_array[cluster_id, :, num_aff_fiber, trial_idx] = np.array(dend_i_ampa_list[cluster_id])
