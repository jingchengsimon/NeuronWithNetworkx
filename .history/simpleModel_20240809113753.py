...
class CellWithNetworkx:
    ...
    def run_simulation(self, num_aff_fiber, num_trial):
        ...
        clustered_sec = self.section_synapse_df[self.section_synapse_df['type'] == 'C']['section_synapse'].iloc[:1]
        num_bg_exc_syn_on_clustered_sec = self.section_synapse_df[(self.section_synapse_df['section_synapse'].isin(clustered_sec)) & 
                                                           (self.section_synapse_df['type'] == 'A')]['synapse']
        for exc_syn in num_bg_exc_syn_on_clustered_sec:
        ...
        for exc_syn_id in range(len(num_bg_exc_syn_on_clustered_sec)):
