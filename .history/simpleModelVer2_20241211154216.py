    ...
    def assign_clustered_synapses(self, basal_channel_type, sec_type, dis_to_root, 
        ...
        for i in range(self.num_clusters):
            ...
            while True:
                ...
                syn_ctr = sec_syn_bg_exc_ordered_df.loc[rng.choice(sec_syn_bg_exc_ordered_df[sec_syn_bg_exc_ordered_df['section_id_synapse'] == 82].index)]
                ...
                if num_syn_per_clus > 1:
                    ...
                    # while len(dis_syn_from_ctr) < num_syn_per_clus - 1:
                        ...
                        suc_exceed_flag = (list(self.DiG.successors(syn_suc_sec_id)) == [] or (not all(sec_id in np.unique(sec_syn_bg_exc_ordered_df['section_id_synapse']) for sec_id in list(self.DiG.successors(syn_suc_sec_id))))
