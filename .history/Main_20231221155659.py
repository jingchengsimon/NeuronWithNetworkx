...
num_clusters, cluster_radius, distance_to_soma, num_conn_per_preunit = 1, 5, 1, 3
bg_syn_freq = 1

for bg_syn_freq in [1, 5, 10, 20, 50, 100]:
# 创建保存文件夹
pref_ori_dg = 0
# folder_path = f'./results/simulation/spt/dist{distance_to_soma}_degree{pref_ori_dg}_nClusters{num_clusters}_exp2syn'
folder_path = f'./results/simulation/pseudo/dist{distance_to_soma}_nClusters{num_clusters}_bgFreq{bg_syn_freq}_exp2syn'
