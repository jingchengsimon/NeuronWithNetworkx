...
class CellWithNetworkx:
    ...
    def assign_clustered_synapses(self, basal_channel_type, sec_type, dis_to_root, 
        ...
        if spat_condition == 'clus':
            ...
            self.num_clusters_sampled = np.min(10, num_preunit * num_conn_per_preunit)
    ...
    def run_simulation(self, num_stim, num_aff_fiber, num_trial, spat_cond, folder_path):
...
def build_cell(**params):
    ...
    simu_folder = sec_type + '_range' + str(distance_to_root) + '_' + spat_condtion + '_' + simu_condition + '_variedW_tau43_addNaK_nonlintest_varynumsyn_step2_woAP+Ca_withclus_aligned_AMPA' # + '_ratio1' + '_exc1.1-1.3' + '_inh4' + '_failprob0.5' + '_funcgroup10'
