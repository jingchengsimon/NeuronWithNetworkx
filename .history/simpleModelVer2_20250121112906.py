...
class CellWithNetworkx:
    ...
    def assign_clustered_synapses(self, basal_channel_type, sec_type, dis_to_root, 
        ...
        if sec_type == 'basal':
            ...
            num_syn_thres = [100 + i * 100 for i in range(2)]
...
def build_cell(**params):
    ...
    simu_folder = sec_type + '_range' + str(distance_to_root) + '_' + spat_condtion + '_' + simu_condition + '_monoconn'# + '_ratio1' #'_exc1' + '_failprob0.5' + '_ratio1' + '_funcgroup3'
