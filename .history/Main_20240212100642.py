...
if __name__ == "__main__":
    ...
    parameters_list = [
        ...
        # {**param_common, **param4_diff},
        # {**param_common, **param5_diff},
        # {**param_common, **param6_diff},
        # {**param_common, **param7_diff},
        # {**param_common, **param8_diff},
        # {**param_common, **param9_diff},
        # {**param_common, **param10_diff},
        # {**param_common, **param11_diff},
        # {**param_common, **param12_diff},
    ]
