...
class CellWithNetworkx:
    ...
    def run_simulation(self, num_stim, num_aff_fiber, num_trial, folder_path):
        ...
        print(len(self.section_synapse_df[(self.section_synapse_df['cluster_id'] == 0)]['segment_synapse'].values), self.section_synapse_df[(self.section_synapse_df['cluster_center_flag'] == 1)]['cluster_id'].values)
