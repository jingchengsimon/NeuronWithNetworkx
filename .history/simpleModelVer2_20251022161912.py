...
def build_cell(**params):
    ...
    channel_suffix = '_singclus_t20ms' if basal_channel_type == 'AMPANMDA' else '_singclus_AMPA_t20ms'
    ...
    folder_path = f'/G/results/simulation_singclus_Oct25/{simu_folder}/{folder_tag}/{epoch}'
