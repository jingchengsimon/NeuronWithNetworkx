...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, simu_condition, input_ratio_basal_apic, bg_exc_channel_type, initW, num_func_group, inh_delay, num_trials):
        ...
        np.save(os.path.join(folder_path,'soma
    ...
    def run_simulation(self, num_stim, num_aff_fiber, num_trial, folder_path):
        ...
        soma_i = h.Vector().record(self.complex_cell.soma[0](0.5)._ref_i)  # Recording current
...
def build_cell(**params):
    ...
    simu_folder = sec_type + '_range' + str(distance_to_root) + '_' + spat_condtion + '_' + simu_condition + '_variedW_EPSPtest' # + '_ratio1' + '_exc1.1-1.3' + '_inh4' + '_failprob0.5' + '_funcgroup10'
