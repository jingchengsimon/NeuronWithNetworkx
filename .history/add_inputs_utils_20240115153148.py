...
def add_background_inh_inputs(section_synapse_df, syn_param_inh, time_interval, DURATION, FREQ_INH, num_syn_inh, lock):  
    ...
    for region in ['basal', 'apical']:
        ...
        spike_counts_inh = spike_counts_basal_inh if region == 'basal' else self.spike_counts_apic_inh
        num_syn_background_inh = num_syn_basal_inh if region == 'basal' else self.num_syn_apic_inh
