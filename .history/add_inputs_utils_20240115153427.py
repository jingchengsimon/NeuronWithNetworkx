...
def add_clustered_inputs(section_synapse_df, syn_param_exc, num_clusters, num_conn_per_preunit, num_syn_to_get_input, basal_channel_type, spike_interval, spt_unit_list):  
