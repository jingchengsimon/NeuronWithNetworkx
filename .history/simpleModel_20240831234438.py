...
class CellWithNetworkx:
    ...
    def run_simulation(self, num_aff_fiber, num_trial):
        ...
        # dend_i_nmda_list = []
        # dend_i_ampa_list = []
        dend_i_list_list = [[] for _ in range(self.num_clusters)]
        dend_i_nmda_list_list = [[] for _ in range(self.num_clusters)]
        dend_i_ampa_list_list = [[] for _ in range(self.num_clusters)]
