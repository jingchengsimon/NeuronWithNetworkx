...
from utils.graph_utils import create_directed_graph, set_graph_order, plot_graph
        ...
        for num_activated_preunit in self.num_activated_preunit_list[15:]: # 40
            for num_stim in range(self.num_stim):
                ...
                for num_trial in range(num_trials): # 20
                    ...
                    if not self.run_simulation(num_stim, num_aff_fiber, num_trial):
                print(f"Condition not met for num_activated_preunit={num_activated_preunit}, skipping to next epoch.")
