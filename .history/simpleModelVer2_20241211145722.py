            ...
            while exceed_flag == False:
                ...
                if num_syn_per_clus > 1:
                    ...
                    # while len(dis_syn_from_ctr) < num_syn_per_clus - 1:
                        ...
                        exceed_flag = (self.rnd.choice(list(self.DiG.successors(syn_suc_sec_id))) not in np.unique(sec_syn_bg_exc_ordered_df['section_id_synapse'])) and
                                      (self.rnd.choice(list(self.DiG.predecessors(syn_pre_sec_id))) not in np.unique(sec_syn_bg_exc_ordered_df['section_id_synapse'])) and
