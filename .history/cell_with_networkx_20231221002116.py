...
class CellWithNetworkx:
    def __init__(self, swc_file):
        ...
        self.spike_interval = 2000/2 # interval=1000(ms)/f
    ...
    def _run_simulation(self, ori_dg, stim_id, stim_index):
        ...
        visualization_params = [ori_dg, stim_id, soma_v, dend_v, apic_v, time_v, spike_times_clustered, dend_i, dend_i_nmda]
        self._visualize_simulation(visualization_params)

    def _visualize_simulation(self, visualization_params):
        ori_dg, stim_id, soma_v, dend_v, apic_v, time_v, spike_times_clustered, dend_i, dend_i_nmda = visualization_params
