...
class CellWithNetworkx:
    ...
    def add_inputs(self, folder_path, simu_condition, input_ratio_basal_apic, bg_exc_channel_type, initW, num_func_group, inh_delay, num_trials):
        ...
        self.num_activated_preunit_list = [self.num_preunit] #[0, 1, 3, 6, 12, 24, 48, 72] #[self.num_preunit] # for multi-clus
...
def build_cell(**params):
    ...
    simu_folder = sec_type + '_range' + str(distance_to_root) + '_' + spat_condtion + '_' + simu_condition + '_variedW_tau43_addNaK_singclus_withAP+Ca_aligned_varyinh_NATURAL' # + '_ratio1' + '_exc1.1-1.3' + '_inh4' + '_failprob0.5' + '_funcgroup10'
