...
folder_path = f'./results/simulation/pseudo/exp2syn_dist{distance_to_soma}_nClus{num_clusters}_r{cluster_radius}_bgFreq{bg_syn_freq}_nSyn{num_syn_per_cluster}'
