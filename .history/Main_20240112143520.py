...
def build_cell(param):
    ...
    NUM_SYN_BASAL_EXC, NUM_SYN_APIC_EXC, NUM_SYN_BASAL_INH, 
                                NUM_SYN_APIC_INHbasal_channel_type, distance_to_soma,num_clusters, num_syn_per_cluster, cluster_radius, bg_syn_freq, num_conn_per_preunit, pref_ori_dg = param.values()
    # 创建保存文件夹
