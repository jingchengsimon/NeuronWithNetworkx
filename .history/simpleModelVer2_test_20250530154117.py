...
class CellWithNetworkx:
    def __init__(self, swc_file, bg_exc_freq, bg_inh_freq, SIMU_DURATION, STIM_DURATION, epoch_idx):
        ...
        self.all_sections = self.sections_soma + self.sections_basal + self.sections_apical # ignore axon
        
        self.all_sections = [sec for sec in h.allsec() if sec.psection()['morphology']['name'] not in ['axon', 'oblique']] # ignore axon and oblique
        ...
        for i in range(self.num_clusters):
            ...
            if sec_type == 'basal':
                sec_syn_bg_exc_ordered_df = self.section_synapse_df[
                    ...
                    (self.section_synapse_df['cluster_cand_flag'] == -1) &
            ...
            while True:
                ...
                syn_ctr_idx = rng.choice(len(sec_syn_bg_exc_ordered_df))
                ...
                if num_syn_per_clus > 1:
                    ...
                    self.section_synapse_df.loc[syn_surround_ctr.iloc[max_clus_mem_idx].index, 'cluster_cand_flag'] = 1
            ...
            self.section_synapse_df.loc[syn_ctr.name, 'cluster_cand_flag'] = 1
    ...
    def add_inputs(self, folder_path, simu_condition, input_ratio_basal_apic, bg_exc_channel_type, initW, num_func_group, inh_delay, num_trials):
        ...
        for num_stim in range(1, self.num_stim + 1):
            spt_unit_array = generate_vecstim(self.unit_ids, num_stim, self.stim_time, self.SIMU_DURATION)
...
def build_cell(**params):
    ...
    simu_folder = sec_type + '_range' + str(distance_to_root) + '_' + spat_condtion + '_' + simu_condition + '_WATERSHED' # + '_ratio1' + '_exc1.1-1.3' + '_inh4' + '_failprob0.5' + '_funcgroup10'
