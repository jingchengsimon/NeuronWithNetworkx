...
def add_single_synapse(section_df, num_syn, region, sim_type, sections_basal, sections_apical, rnd, lock):
        ...
        def generate_synapse(_):
            ...
            with lock:
                section_synapse_df = self.section_synapse_df.append(data_to_append, ignore_index=True)
