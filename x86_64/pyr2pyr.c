...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 pyr2pyr /G/MIMOlab/Codes/NeuronWithNetworkx/mod/pyr2pyr.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/G/MIMOlab/Codes/NeuronWithNetworkx/mod/pyr2pyr.mod";
static const char* nmodl_file_text = 
